...
/**
 * A workflow to test the {@link QueryDQPClient} Activity.
 *
 */
@Slf4j
...
extends BaseWorkflow
    ...
    public interface Param {
        ...
        /**
         * The {@link CreateDQPClient} params. 
         *
         */
        public CreateDQPClient.Param create();
    ...
    protected ResourceWorkflowResult create(final Param param)
        ...
        final CreateDQPClient create = new CreateDQPClient(
            param.create()
            );
        workflow.add(
            create
