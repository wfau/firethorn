...
extends BaseActivity
     ...
     *
     */
    public CreateDQPClient(final Param param)
        {
        super(
            new ActivityName(
                CreateDQPParam.ACTIVITY_NAME
                )
            );
        input = new SimpleActivityInput(
            CreateDQPParam.TARGET_RESOURCES,
