...
/**
 * Equality comparison expression.  Evaluates to true if the values of the
 * left and right operands are equal.
 *
 * @author The OGSA-DAI Project Team.
 */
public class EqualExpression extends ComparisonExpressionBase
{
    /** Copyright notice. */
     ...
     */
    public EqualExpression(final Operand lhs, final Operand rhs)
    {
        mLHS = lhs;
        mRHS = rhs;
    }
