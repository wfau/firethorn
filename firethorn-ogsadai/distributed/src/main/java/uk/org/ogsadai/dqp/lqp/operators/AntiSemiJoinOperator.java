...
/**
 * Operator ANTI_SEMI_JOIN.
 * 
 * @author The OGSA-DAI Project Team.
 */
public class AntiSemiJoinOperator extends AbstractJoinOperator
{
    /** Copyright notice. */
    ...
    /**
     * Default constructor. Creates a disconnected ANTI SEMI JOIN operator.
     * 
     * @param predicate
     *            filter predicate
     */
    public AntiSemiJoinOperator(Predicate predicate)
    {
        mID = OperatorID.ANTI_SEMI_JOIN;
