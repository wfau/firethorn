...
/**
 * Scalar function to calculate mod.
 * 
 * @author The OGSA-DAI Project Team.
 *
 */
public class Mod extends LogicalExecutableFunctionBase {
    ...
    /** The data type of X in the expression mod(X, Y). */
    private int mTypeX = -1;

    /** The data type of Y in the expression mod(X, Y). */
    ...
    public void configure(int... types) throws TypeMismatchException {
        ...
        mTypeX = types[0];
        mTypeY = types[1];
        mResultType = TypeConverter.getArithmeticType(mTypeX, mTypeY);
    }
    ...
    public void put(Object... parameters) {
        ...
        else
        {
            ...
            Object y = null;
            try {
                x = TypeConverter.convertObject(mTypeX, mResultType, parameters[0]);
                y = TypeConverter.convertObject(mTypeY, mResultType, parameters[1]);
