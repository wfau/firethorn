...
import uk.org.ogsadai.expression.arithmetic.visitors.FuncExtrArithmeticExprVisitor;

/**
 * Function extracting expression visitor.
 * 
 * @author The OGSA-DAI Project Team.
 */
public class FuncExtrExpressionVisitor extends AttrExpressionVisitorBase
{
    /** Copyright notice. */
    ...
    {
        FuncExtrArithmeticExprVisitor visitor = 
            new FuncExtrArithmeticExprVisitor();
        ((ArithmeticExpressionOperand) operand).getExpression().accept(visitor);
        mFunctions.addAll(visitor.getFunctions());
    }
