...
/**
 * Operator DUPLICATE ELIMINATION.
 * 
...
public class DuplicateEliminationOperator extends UnaryOperator
{
    ...
    /**
     * Create a disconnected DUPLICATE_ELIMINATION operator.
     */
    protected DuplicateEliminationOperator()
    {
        mID = OperatorID.DUPLICATE_ELIMINATION;
    }

    /**
     * Create a connected DUPLICATE_ELIMINATION operator.
     * 
     * @param child
     *            child operator
     */
