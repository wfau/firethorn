...
public class CloneExpressionVisitor implements ExpressionVisitor
{
    ...
    {
        visitComparison(expression);
        mClonedExpression = new GreaterThanExpression(mLeftOperand,
            mRightOperand);
    }
    ...
    {
        visitComparison(expression);
        mClonedExpression = new GreaterThanOrEqualExpression(mLeftOperand,
            mRightOperand);
    }
    ...
    {
        visitComparison(expression);
        mClonedExpression = new LessThanOrEqualExpression(mLeftOperand,
            mRightOperand);
    }
    ...
    public void visitInExpression(InExpression expression)
    {
        ...
        List<Operand> rightOperands = 
            new ArrayList<Operand>(expression.getRightOperands().size());
    ...
    {
        return new ArithmeticExpressionOperand(
            CloneArithmeticExprVisitor.cloneExpression(
