...
/**
 * Expression that implements a less than comparison.
 *
 * @author The OGSA-DAI Project Team.
 */
public class LessThanExpression extends ComparisonExpressionBase
{
    /** Copyright notice. */
     ...
     */
    public LessThanExpression(final Operand lhs, final Operand rhs)
    {
        mLHS = lhs;
        mRHS = rhs;
    }
