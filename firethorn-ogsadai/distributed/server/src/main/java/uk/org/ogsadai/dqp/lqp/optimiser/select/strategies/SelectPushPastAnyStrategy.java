...
/**
 * Pushes SELECT down past any unary operator.
 * 
 * @author The OGSA-DAI Project Team.
 */
public class SelectPushPastAnyStrategy implements SelectPushDownStrategy
{
    /** Copyright notice. */
    ...
    {
        return SelectStrategyUtils.pushDownNoChange(selectOperator);
    }
}
