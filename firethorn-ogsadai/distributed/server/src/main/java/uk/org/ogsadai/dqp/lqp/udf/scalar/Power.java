 ...
 */
public class Power extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Power.class);

    /** The function's name. */
    private static final String FUNCTION_NAME = "Power";
    
    /** The result. */
    private Object mResult;
    
    /** The data type of X in the expression POWER(X, Y). */
    private int mTypeX = -1;

    /** The data type of Y in the expression POWER(X, Y). */
    ...
    /**
     * Returns the type of X for the expression POWER(X,Y).
     * 
     * @return type.
     */
    ...
    /**
     * Returns the type of Y for the expression POWER(X,Y).
     * 
     * @return type.
     */
