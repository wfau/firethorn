...
/**
 * Operator INNER THETA JOIN.
 * 
 * @author The OGSA-DAI Project Team.
 */
public class InnerThetaJoinOperator extends AbstractJoinOperator
{
    /** Copyright notice. */
     ...
     * Constructor.
     */
    protected InnerThetaJoinOperator()
    {
        mID = OperatorID.INNER_THETA_JOIN;
    }

    /**
     * Creates a disconnected INNER THETA JOIN operator.
     * 
     * @param predicate
     *            join predicate
     */
    public InnerThetaJoinOperator(Predicate predicate)
    {
        this();
		...
		attrSet)))
	{
        ...
        if(!equiOnUnique)
        {
            ...
            mOperatorHeading = lH.createMerged(rH);
        }
    }
