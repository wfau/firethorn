...
public abstract class ASTConstants
{
    ...
    public static final String EXCEPT_TOKEN = "EXCEPT";
    public static final String UNION_ALL_TOKEN = "UNION_ALL";
    public static final String EXCEPT_ALL_TOKEN = "EXCEPT_ALL";
    ...
    public static final String BETWEEN_TOKEN = "BETWEEN";
    ...
    public static final String TABLECOLUMN_TOKEN = "TABLECOLUMN";
    ...
    public static final String FROM_LIST_TOKEN = "FROM_LIST";
    public static final String SELECT_LIST_TOKEN = "SELECT_LIST";
