...
/**
 * Scalar Log10 function. 
 * The parameter value can be any Number type. The output type is always a
 * Double.
 *
 * @author The OGSA-DAI Project Team.
 */
public class Log10 extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Log10.class);

    /** The function's name. */
    private static final String FUNCTION_NAME = "Log10";
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.log10(((Number)parameters[0]).doubleValue());
        }
    } 
