 ...
 */
public class SemiJoinOperator extends AbstractJoinOperator
{
    /** Copyright notice. */
    ...
    /**
     * Constructor. Constructs a disconnected SEMI_JOIN operator.
     * 
     * @param predicate
     *            filter predicate
     */
    public SemiJoinOperator(Predicate predicate)
    {
        mID = OperatorID.SEMI_JOIN;
