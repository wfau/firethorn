...
public class Annotation
{
    ...
    /** Cardinality. */
    public static final String CARDINALITY_STATS = "CardinalityStatistics";
    /* Evaluation node. */
     ...
     */
    public static void addCorrelatedSetAnnotation(Operator operator,
        Set<Attribute> correlatedSet)
    {
     ...
     */
    public static void addCardinalityAnnotation(Operator operator,
        Double cardinality)
    {
     ...
     */
    public static Double getCardinalityAnnotation(Operator operator)
    {
        return (Double) operator.getAnnotation(CARDINALITY);
    }

    /**
     * Adds the cardinality statistics annotation.
     * 
     * @param operator
     *            operator to be annotated
     * @param cardinalityStats
     *            cardinality statistics
     */
    public static void addCardinalityStatisticsAnnotation(Operator operator,
        CardinalityStatistics cardinalityStats)
    {
        operator.addAnnotation(CARDINALITY_STATS, cardinalityStats);
    }

    /**
     * Gets the value of <code>CardinalityStatistics</code> annotation.
     * 
     * @param operator
     *            annotated operator
     * @return cardinality statistics or <code>null</code> if non existent
     */
    public static CardinalityStatistics 
        getCardinalityStatisticsAnnotation(Operator operator)
    {
        return (CardinalityStatistics) 
            operator.getAnnotation(CARDINALITY_STATS);
    }
     ...
     */
    public static void addCorrAttrAnnotation(Attribute attribute,
        boolean correlated)
    {
     ...
     */
    public static void addTempAttrAnnotation(Attribute attribute,
        boolean temporary)
    {
     ...
     *            if temporary
     */
    public static void addTempAttrAnnotation(Function function,
        boolean temporary)
    {
     ...
     */
    public static void addImplementationAnnotation(Operator operator,
        String name)
    {
     ...
     * @param partition
     */
    public static void addPartinionAnnotation(Operator operator,
        Partition partition)
    {
     ...
     */
    public static void addEvaluationNodeAnnotation(Operator operator,
    ...
    {
        return (operator.getAnnotation(DATA_NODE) != null) 
            ? ((DataNode) operator.getAnnotation(DATA_NODE)).getEvaluationNode()
            : (EvaluationNode) operator.getAnnotation(EVALUATION_NODE);
    }
     ...
     * @param dataNode
     */
    public static void addDataNodeAnnotation(Operator operator,
        DataNode dataNode)
    {
