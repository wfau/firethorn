...
/**
 * Builds activities for operator ANTI SEMI JOIN.
 *
 * @author The OGSA-DAI Project Team.
 */
public class AntiJoinBuilder implements ActivityPipelineBuilder
{
    /** Copyright notice. */
    ...
    {
        AntiSemiJoinOperator operator = (AntiSemiJoinOperator)op;
        SingleActivityOutput outputLeft = outputs.get(0);
        SingleActivityOutput outputRight = outputs.get(1);
        
        // TODO: Change activity so it does not accept a predicate
        String sql = operator.getPredicate().toString();
        
        GenericActivity join =
            new GenericActivity("uk.org.ogsadai.TupleAntiJoin");
