...
/**
 * Scalar Floor function. 
 * <p>
 * The Floor(x) function returns the integer value not greater than x. 
 * <p>
 ...
 */
public class Floor extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Floor.class);
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.floor(((Number)parameters[0]).doubleValue());
        }
    } 
