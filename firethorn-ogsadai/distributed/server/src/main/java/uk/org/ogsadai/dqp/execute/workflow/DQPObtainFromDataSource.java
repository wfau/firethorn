...
/**
 * The subclass of GenericActivity that is used by DQP to represent an 
 * ObtainFromDataSource activity.  The actual activity to use and its inputs
 ...
 */
public class DQPObtainFromDataSource extends GenericActivity
{
    /** Copyright notice */
    private static final String COPYRIGHT_NOTICE = 
        "Copyright (c) The University of Edinburgh, 2009.";
    
    /** Evaluation node on which the data source resource resides. */
     ...
     */
    public DQPObtainFromDataSource(String activityName)
    {
        super(activityName);
    }
    
    /**
     * Sets the evaluation node on which the data source resource resides.
     * 
