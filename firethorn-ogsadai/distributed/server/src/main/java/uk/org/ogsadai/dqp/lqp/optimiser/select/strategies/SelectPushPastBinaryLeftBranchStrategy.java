...
/**
 * Pushes select past binary operator into the left (position 0) branch.
 * 
 * @author The OGSA-DAI Project Team.
 */
public class SelectPushPastBinaryLeftBranchStrategy implements
    SelectPushDownStrategy
{
    ...
    private static final DAILogger LOG = DAILogger
        .getLogger(SelectPushPastBinaryLeftBranchStrategy.class);
