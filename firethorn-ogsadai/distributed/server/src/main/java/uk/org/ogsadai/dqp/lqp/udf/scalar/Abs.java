 ...
 */
public class Abs extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.abs(((Number)parameters[0]).doubleValue());
        }
    } 
