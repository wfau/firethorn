 ...
 */
public class Round extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Round.class);
    ...
    /** The data type of X in the expression ROUND(X, Y). */
    private int mTypeX = -1;

    /** The data type of Y in the expression ROUND(X, Y). */
    ...
    /**
     * Returns the type of X for the expression ASIN(X,Y).
     * 
     * @return type.
     */
    ...
    /**
     * Returns the type of Y for the expression ASIN(X,Y).
     * 
     * @return type.
     */
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.round((Double)parameters[0]);
        }
    } 
