 ...
 * @author stv
 */
public class Degrees extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Degrees.class);

    /** The function's name. */
    private static final String FUNCTION_NAME = "Degrees";
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.toDegrees(((Number)parameters[0]).doubleValue());
        }
    } 
