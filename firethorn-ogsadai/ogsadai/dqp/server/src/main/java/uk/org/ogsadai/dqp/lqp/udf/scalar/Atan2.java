...
/**
 * Scalar Atan2 function. 
 * The parameter value can be any Number type. The output type is always a
 * Double.
 *
 * @author The OGSA-DAI Project Team.
 */
public class Atan2 extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Atan2.class);

    /** The function's name. */
    private static final String FUNCTION_NAME = "Atan2";
    
    /** The result. */
    private Object mResult;
    
    /** The data type of X in the expression ATAN2(X, Y). */
    private int mTypeX = -1;

    /** The data type of Y in the expression ATAN2(X, Y). */
    ...
    /**
     * Returns the type of X for the expression ATAN2(X,Y).
     * 
     * @return type.
     */
    ...
    /**
     * Returns the type of Y for the expression ATAN2(X,Y).
     * 
     * @return type.
     */
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.atan2((Double)parameters[0],(Double)parameters[1]);
        }
    } 
