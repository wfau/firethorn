...
/**
 * Expression that implements a greater than or equal to comparison.
 *
 * @author The OGSA-DAI Project Team.
 */
public class GreaterThanOrEqualExpression extends ComparisonExpressionBase
{
    /** Copyright notice. */
     ...
     */
    public GreaterThanOrEqualExpression(final Operand lhs, final Operand rhs)
    {
        mLHS = lhs;
        mRHS = rhs;
    }
