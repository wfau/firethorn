 ...
 */
public class Atan extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Atan.class);
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.atan(((Number)parameters[0]).doubleValue());
        }
    } 
