...
/**
 * Scalar Radians function. 
 * The parameter value can be any Number type. The output type is always a
 * Double.
 *
 * @author The OGSA-DAI Project Team.
 */
public class Radians extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Radians.class);

    /** The function's name. */
    private static final String FUNCTION_NAME = "Radians";
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.toRadians(((Number)parameters[0]).doubleValue());
        }
    } 
