...
/**
 * Raised if an IO exception occurred whilst storing tuples to a file.
 *
 * @author The OGSA-DAI Project Team.
 */
public class IOException extends DAIUncheckedException
{
    /** Copyright notice. */
    ...
    public static final ErrorID ERROR_ID =
        new ErrorID("uk.org.ogsadai.IO_RUNTIME_EXCEPTION");
