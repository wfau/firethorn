...
public class GroupTuple extends ComparableTuple
{
    ...
    public void evaluate(Tuple tuple)
    {
        ...
        {
            // TODO: maybe do something more sensible here?
    ...
    public void mergeGroups(GroupTuple group)
    {
        if (group.mAggregates != null)
        {
            ...
            {
                SerialisableFunction aggregate = 
                    (SerialisableFunction)mAggregates[i].getExecutable();
                aggregate.merge(
                        (SerialisableFunction)group.mAggregates[i].getExecutable());
            }
        }
    }
