...
/**
 * Tries to pull RENAME past unary operator with attribute rename.
 * 
 * @author The OGSA-DAI Project Team.
 */
public class RenamePullPastUnaryUpdateParentStrategy implements
        RenamePullUpStrategy 
{
    /** Copyright notice. */
    ...
    public RenameOperator pullUp(RenameOperator operator)
    {
        try
        {
            ...
            RenameOperator result = RenameStrategyUtils.pullPastUnary(operator);
