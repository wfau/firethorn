...
/**
 * Scalar function to extract the hour of day from a timestamp or time.
 * Example use, GetHourOfDay(timestampColumn), GetHourOfDay(timeColumn).
 * 
 * @author The OGSA-DAI Project Team
 */
public class GetHourOfDay extends LogicalExecutableFunctionBase
{
    /** Copyright notice. */
     ...
     * method was called.
     * 
     * @param getHourOfDay instance from which to copy state.
     */
    public GetHourOfDay(GetHourOfDay getHourOfDay)
    {
        this();
        mType = getHourOfDay.mType;
    }
    ...
    public Object getResult()
    {
        ...
        {
            return new Long(mDateTime.getHourOfDay());
        }
    }
