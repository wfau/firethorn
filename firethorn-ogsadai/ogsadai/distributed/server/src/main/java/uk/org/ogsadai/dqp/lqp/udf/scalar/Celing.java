 ...
 */
public class Celing extends LogicalExecutableFunctionBase 
{
    /** Copyright notice. */
    ...
    private static final DAILogger LOG = 
        DAILogger.getLogger(Celing.class);
    ...
    public void put(Object... parameters)
    {
        ...
        {
            mResult = Math.ceil(((Number)parameters[0]).doubleValue());
        }
    } 
