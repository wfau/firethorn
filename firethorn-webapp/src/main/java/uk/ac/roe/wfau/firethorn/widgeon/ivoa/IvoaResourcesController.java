...
extends AbstractEntityController<IvoaResource, IvoaResourceBean>
     ...
     *
     */
    public static final String SELECT_NAME = "ivoa.resource.select.name" ;

    /**
     * MVC property for the select results.
     *
     */
    public static final String SELECT_RESULT = "ivoa.resource.select.result" ;
    ...
    /**
     * MVC property for the TAP service endpoint.
     *
     */
