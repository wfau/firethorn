 ...
 */
@Controller
@RequestMapping(AdqlTableLinkFactory.HTML_TABLE_PATH)
public class AdqlTableHTMLTableController
extends BaseTableHTMLTableController
     ...
     *
     */
    public AdqlTableHTMLTableController()
        {
        super();
        }
    ...
    public Path path()
        {
        return path(
            AdqlTableLinkFactory.HTML_TABLE_PATH
            );
        }
