...
import uk.ac.roe.wfau.firethorn.webapp.votable.AdqlQueryCSVController.BaseFieldHandler;
import uk.ac.roe.wfau.firethorn.webapp.votable.AdqlQueryCSVController.FieldHandler;
import uk.ac.roe.wfau.firethorn.webapp.votable.AdqlQueryCSVController.StringFieldHandler;

/**
 * Spring MVC Controller to generate a CSV response for a table.
 * 
 ...
 */
@Slf4j
public abstract class BaseTableCSVController
extends AbstractTableController
    ...
    extends AbstractFormatter
        {
        public CSVFormatter(final BaseColumn<?> column)
            {
            super(
                column
                );
