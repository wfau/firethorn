 ...
 */
@Component
public class OgsaExecResourceLinkFactory
extends WebappLinkFactory<OgsaExecResource>
implements OgsaExecResource.LinkFactory
    {
    protected OgsaExecResourceLinkFactory()
        {
        super(
            BASE_PATH
            );
     ...
     *
     */
    public static final String BASE_PATH = "/ogsa/exec";
    ...
    @Override
    public String link(final OgsaExecResource entity)
        {
        return this.link(
            ENTITY_PATH,
            entity
    ...
    @Autowired
    private OgsaExecResource.EntityFactory factory ;
    @Override
    public OgsaExecResource resolve(String link)
