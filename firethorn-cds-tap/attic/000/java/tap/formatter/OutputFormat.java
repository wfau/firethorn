...
public interface OutputFormat<R> {
	 ...
	 */
	public void writeResult(final R queryResult, final OutputStream output, final ADQLExecutor<R> job) throws TAPException;
	 ...
	 * @throws TAPException		If there is an error while formatting/writing the query result.
	 */
	public Result writeResult(final R queryResult, final ADQLExecutor<R> job) throws TAPException;
