...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnAjaxParameters( oSettings )
		{
			...
			var i;
			if (oSettings['save_as']!=null){
				aoData.push({"name": "save_as","value": oSettings['save_as']});
			}
			oSettings['save_as'] = null;
			...
			for ( i=0 ; i<iColumns ; i++ )
			{
			  ...
			  if (typeof(oSettings.aoColumns[i].mDataProp)== 'number') {
				  mDataProp = oSettings.aoColumns[i].sTitle;
			  }
