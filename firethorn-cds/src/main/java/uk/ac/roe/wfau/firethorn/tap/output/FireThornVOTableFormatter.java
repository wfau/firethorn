...
extends FireThornOutputFormat
	...
	private final FireThornServiceConnection service;

	public FireThornVOTableFormatter(final FireThornServiceConnection service)
	    {
	...
	@Override
	public void writeResult(FireThornTapResult result, OutputStream output, ADQLExecutor<FireThornTapResult> job)
	throws TAPException
	    {
		try{
...
ResultSet queryResult = result.results();
	...
	protected void writeHeader(final PrintWriter output, final ADQLExecutor<FireThornTapResult> job)
	...
	protected DBColumn[] writeMetadata(final ResultSet queryResult, final PrintWriter output, final ADQLExecutor<FireThornTapResult> job)
	throws IOException, TAPException
	    {
	...
	protected void writeFieldMeta(TAPColumn col, PrintWriter out)
	throws IOException, TAPException
	    {
	...
	protected int writeData(final ResultSet queryResult, final DBColumn[] selectedColumns, final OutputStream output, final ADQLExecutor<FireThornTapResult> job)
	throws IOException, TAPException
	    {
		int nbRows = 0;
		try {
	...
	protected void writeFieldValue(final Object value, final DBColumn column, final OutputStream output)
    throws IOException, TAPException
        {
