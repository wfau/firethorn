...
public class DemoTAP_CSVFormatter extends DemoTAP_Formatter {
	...
	public DemoTAP_CSVFormatter(char colSeparator){
		this(colSeparator, true);
	}

	public DemoTAP_CSVFormatter(char colSeparator, boolean delimitStrings){
		separator = ""+colSeparator;
		delimitStr = delimitStrings;
	}

	public DemoTAP_CSVFormatter(String colSeparator){
		this(colSeparator, true);
	}

	public DemoTAP_CSVFormatter(String colSeparator, boolean delimitStrings){
	...
	public void writeResult(final ResultSet queryResult, final OutputStream output, final ADQLExecutor<ResultSet> job) throws TAPException {
		try{
