...
public abstract class UWSSerializer implements Serializable {
	...
	/** If a serialization string starts with this string, the result file with the following ID must be read and returned in the HTTP response. */
	public static final String READ_RESULT_FILE = "RESULT@";
	 ...
	 * @throws UWSException	If there is an error during the serialization.
	 */
	public abstract String getUWS(final AbstractUWS<? extends JobList<? extends AbstractJob>, ? extends AbstractJob> uws, final JobOwner user) throws UWSException;
	 ...
	 * @throws UWSException	If there is an error during the serialization.
	 */
	public abstract String getJobList(final JobList<? extends AbstractJob> jobsList, JobOwner owner, final boolean root) throws UWSException;
	 ...
	 * @since 3.1
	 */
	public abstract String getJobRef(final AbstractJob job, final UWSUrl jobsListUrl) throws UWSException;
