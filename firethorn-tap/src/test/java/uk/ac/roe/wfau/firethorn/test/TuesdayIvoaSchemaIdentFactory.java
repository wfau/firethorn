 ...
 */
@Component
public class TuesdayIvoaSchemaIdentFactory
extends TuesdayTestIdentFactory<TuesdayIvoaSchema>
implements TuesdayIvoaSchema.IdentFactory, TuesdayIvoaSchema.LinkFactory
    {
    }
