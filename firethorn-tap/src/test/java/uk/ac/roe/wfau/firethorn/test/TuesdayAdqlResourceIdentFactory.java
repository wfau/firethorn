 ...
 */
@Component
public class TuesdayAdqlResourceIdentFactory
extends TuesdayTestIdentFactory<TuesdayAdqlResource>
implements TuesdayAdqlResource.IdentFactory, TuesdayAdqlResource.LinkFactory
    {
    }
