...
public class HamblyTestCase
    ...
    public void test004()
        ...
        validate(
            ...
            " FROM gpsSource AS s, gpsMergeLog AS l, gpsDetection AS d, Multiframe AS m " +
    ...
    public void test012()
        ...
        validate(
            ...
            " x.distanceMins IN  " + 
	            ...
	            " AND psfMag_i > 0.0 AND psfMag_i - yAperMag3 > 4.0 AND ymj_1Pnt < 0.8  " + 
    ...
    public void test013()
        ...
        validate(
            Level.LEGACY,
            State.VALID,
            " SELECT s.ra as alpha, s.dec as delta, (petroMag_u - extinction_u) AS u, (petroMag_g - extinction_g) AS g, " +
            " (petroMag_r - extinction_r) AS r , (petroMag_i - extinction_i) AS i, (petroMag_z - extinction_z) AS z, (yPetroMag-ay) AS y , " +
            " (j_1PetroMag-aj) AS j, (hPetroMag-ah) AS h, (kPetroMag-ak) AS k, z.z AS redshift, (modelMag_g - extinction_g) - ( modelMag_r - extinction_r) AS gmr , " +
            " (yAperMag3 - ay)-(kAperMag3 - ak) AS ymk, (modelMag_u - extinction_u) - (modelMag_g - extinction_g) AS umg, (kPetroMag - ak) - 25 - 5 * ( LOG10(2 * 2.998e5 * (1 + z.z - SQRT(1 + z.z))/75) ) AS M_K " +  
