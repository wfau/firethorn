...
extends AtlasQueryTestBase
    ...
    throws Exception
        ...
        validate(
            ...
            new ExpectedField[] {
                new ExpectedField("fHMS", AdqlColumn.AdqlType.CHAR, 32),
                new ExpectedField("fDMS", AdqlColumn.AdqlType.CHAR, 32)
                }
            );
        }
    ...
    throws Exception
        ...
        validate(
            ...
            new ExpectedField[] {
                new ExpectedField("fra",  AdqlColumn.AdqlType.CHAR, 32),
                new ExpectedField("fdec", AdqlColumn.AdqlType.CHAR, 32)
                }
            );
        }
    }
