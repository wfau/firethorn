...
extends RuntimeException
     ...
     *
     */
    private static final long serialVersionUID = -6177250568926069107L;
    
    /**
     * Default message for simple constructor.
     *
     */
    public static final String DEFAULT_MESSAGE = "Duplicate name [:name:]" ;
     ...
     *
     */
    public DuplicateNameException(final String name, final String message)
        {
        this(
            name,
            message,
     ...
     *
     */
    public DuplicateNameException(final String name, final Throwable cause)
        {
        this(
            name,
            message(
     ...
     *
     */
    public DuplicateNameException(final String name, final String message, final Throwable cause)
        {
        super(
            message,
            cause
