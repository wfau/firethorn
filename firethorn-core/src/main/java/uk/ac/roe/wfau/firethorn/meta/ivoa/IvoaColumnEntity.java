...
@NamedQueries(
        ...
        @NamedQuery(
            ...
            query = "FROM IvoaColumnEntity WHERE (parent = :parent) ORDER BY name desc"
            ),
        @NamedQuery(
            name  = "IvoaColumn-select-parent.ident",
            query = "FROM IvoaColumnEntity WHERE ((parent = :parent) AND (ident = :ident)) ORDER BY name desc"
            ),
        @NamedQuery(
            name  = "IvoaColumn-select-parent.name",
            query = "FROM IvoaColumnEntity WHERE ((parentAdql = :parent) AND (name = :name)) ORDER BY name desc"
            ),
        @NamedQuery(
